 ...
 * generated in the com.streamsimple.pmml.config.v4.v3 package.
...
{
  private static final QName _SpectralAnalysis_QNAME = new QName("http://www.dmg.org/PMML-4_3", "SpectralAnalysis");
  private static final QName _ARIMA_QNAME = new QName("http://www.dmg.org/PMML-4_3", "ARIMA");
  ...
  private static final QName _SeasonalTrendDecomposition_QNAME = new QName("http://www.dmg.org/PMML-4_3", "SeasonalTrendDecomposition");
  ...
  private static final QName _Array_QNAME = new QName("http://www.dmg.org/PMML-4_3", "Array");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.streamsimple.pmml.config.v4.v3
   */
  ...
  {
    return new JAXBElement<List<Integer>>(_INTEntries_QNAME, ((Class)List.class), null, value);
  }
  ...
  {
    return new JAXBElement<List<Double>>(_REALEntries_QNAME, ((Class)List.class), null, value);
  }
  ...
  {
    return new JAXBElement<List<Integer>>(_Indices_QNAME, ((Class)List.class), null, value);
  }
